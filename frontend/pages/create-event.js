...
import UploadIcon from "../public/logos/upload.svg";
            ...
            <div className="space-y-6 sm:space-y-5">
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                ...
                >
                  Event image
                  <p className="mt-1 max-w-2xl text-sm text-gray-400">
                    An image describing your virtual event
                  </p>
                </label>
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <div className="block max-w-lg h-fit min-h-[4rem] border-2 border-dashed border-gray-300 rounded-md">
                    <input
                      id="event-image"
                      name="event-image"
                      type="file"
                      accept="image/*"
                      className="absolute max-w-lg w-full opacity-0 p-4 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm cursor-pointer border-2"
                      required
                    ...
                    {eventImage ? (
                      ...
                      <div className="inline-block relative top-[.8rem] left-[47%] text-gray-500">
                        <Image width={24} src={UploadIcon} alt="upload icon" />
                      </div>
                    )}
                  </div>
                </div>
