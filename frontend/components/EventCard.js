...
export default function EventCard({ id, name, eventTimestamp, imageURL, fallbackImageURL }) {
  return (
    <div className="group relative clickable-card rounded-lg focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-indigo-500">
      ...
      <Image priority={true} unoptimized src={imageURL} alt="event image" onError={({ target }) => target.src= fallbackImageURL} layout="fill" />
      </div>
